...
export const EAS_CHAIN_CONFIGS: { [chainId: number]: EASChainConfig } = {
  0: { //Empty config for typescript
    chainId: 0,
    chainName: "",
    subdomain: "",
    version: "",
    contractAddress: "",
    eas: new EAS("0xC2679fBD37d54388Ce493F1DB75320D236e1815e"),
  ...
  11155111: {
    ...
    metIrlSchema: "0xc59265615401143689cbfe73046a922c975c99d97e4c248070435b1104b2dea7",
    confirmSchema: "0xb96446c85ce538c1641a967f23ea11bbb4a390ef745fc5a9905689dbd48bac86"
  }
};

export const EASConfigContext = createContext<EASChainConfig>(EAS_CHAIN_CONFIGS[0]);
// React context provider that carries the EAS chain config
export const EasConfigContextProvider = ({ chainId, children }: { chainId: number, children: any }) => {
  const config = EAS_CHAIN_CONFIGS[chainId];

  if (!config) {
    return <div>Could not find an EAS config for chainid {chainId}</div>;
  }
  return <EASConfigContext.Provider value={config}>
    {children}
